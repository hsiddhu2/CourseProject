...
def main():
    ...
    print("Number of Document:"+str(len(corpus)))
    muArr = [0.6, 0.7, 0.8, 0.9, 1.0]
    ...
    for j in muArr:
        ...
        for i in range(5):
            ...
            model = runLda(corpus,number_topics,dictionary,prior,j)
            ...
            if (len(significantTopics) != 0):
                ...
                avg_purity_list.append(60)
        plt.subplot(2, 2, 1)
        plt.plot(iteration_list,avg_purity_list,marker='o',label = "Mu:"+str(j))
        plt.subplot(2, 2, 2)
        plt.plot(iteration_list, avg_conf_list, marker='o', label="Mu:" + str(j))
        #mu = mu + 0.1
    plt.subplot(2, 2, 1)

...
def preprocessData():
    ...
    for x in f:
        ...
        filter = [lambda x: x.lower(), strip_punctuation, remove_stopwords, strip_numeric,
...
def calculatePrior(WS, significantTopics, model, datedocument, goreNormProbability, vocabulary_size, number_topics,
                   dictionary):
    ...
    for i in significantTopics:
        ...
        for y in top_word_tuple:
            ...
            if pvalue != None and lag != None:
                ...
                if total_prob <= probM and dictionary[id] != "bush" and dictionary[id] != "gore" and dictionary[
                    id] != "mr":
